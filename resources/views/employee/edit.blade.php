        ...
        <form method="post" action="{{url('employee/'.$data->id)}}">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>Address</th>
                    <td>
                        <input value="{{$data->address}}" name="full_name" class="form-control" />
                    </td>
                </tr>
                <tr>
                    <th>Mobile</th>
                    <td>
                        <input value="{{$data->mobile}}" name="full_name" class="form-control" />
                    </td>
                </tr>
                <tr>
                    <th>Status</th>
                    <td>
                        ...
                        <br />
                        <input @if($data->status==0) checked @endif type="radio" checked="checked" name="status" value="0" /> DeActivate
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
